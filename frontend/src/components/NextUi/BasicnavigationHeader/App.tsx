...
export default function BasicnavigationHeader() {
    return (
        <Navbar
            classNames={{
                base: "lg:bg-transparent lg:backdrop-filter-none md:hidden bg-white",
        ...
        >
            <NavbarBrand>
                ...
                <AcmeIcon />
                <p className="font-bold text-inherit">CutMeets</p>
            </NavbarBrand>
            <NavbarContent
